...
class _MyItemTabState extends CloudState<MyItemTab> {
  ...
  Color _getStatusColor(String? status) {
    switch (status) {
      case "review":
      case "resubmitted":
        return pendingButtonColor.withAlpha(25);
      case "active":
      case "approved":
        return activateButtonColor.withAlpha(25);
      case "inactive":
      case "expired":
      case "permanent rejected":
      case "soft rejected":
        return deactivateButtonColor.withAlpha(25);
      case "sold out":
        return soldOutButtonColor.withAlpha(25);
      default:
        return context.color.territoryColor.withAlpha(25);
    }
  }
